...
- [ ] Update `name` to "Ziva Wernick".
- [ ] Update `seo.title` and `seo.description`.
- [ ] Replace default `socials` with personal links (GitHub, LinkedIn, etc.).
...
## 3. Visual Assets
- [ ] Replace `src/assets/img/logo.svg` with personal logo.
